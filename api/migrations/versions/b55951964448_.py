...
Revision ID: b55951964448
Revises: 
Create Date: 2023-07-18 18:20:07.869293
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_user_community'))
    )
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_user_post'))
    )
